...
class Helper {
  static List getData(Map<String, dynamic> data) {
    return data['data'];
  }

  static getDatajson(Map<String, dynamic> data) {
    return data['data'];
  }

  static getDatajson2(Map<String, dynamic> data) {
    return data;
  }

  static getDat(Map<String, dynamic> data) {
    return data[0];
  }
