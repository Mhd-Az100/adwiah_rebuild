...
//   void scheduleAlarm(DateTime scheduledNotificationDateTime , NotificationModel notificationModel) async {

//     var androidPlatformChannelSpecifics = AndroidNotificationDetails(
//       // 'alarm_notif_${notificationModel.id}',
//       // 'alarm_notif_${notificationModel.id}',
//       'alarm_notif',
//       'alarm_notif',
...
//     await flutterLocalNotificationsPlugin.zonedSchedule(notificationModel.id,
...
// // void addScedualAlarm(int id,String title, String body, DateTime date,) async {
