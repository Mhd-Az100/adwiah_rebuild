...
class AddDrugsPage extends StatefulWidget {
  // List<dynamic> drugsList;
  String? drugsName;
  final lang;
  int? prescriptionId;

  AddDrugsPage({this.drugsName, this.prescriptionId, this.lang = "en"});
  ...
  _saveData() async {
    if (drugsDateController.text.isNotEmpty &&
      ...
      if (result! > 0) {
        ...
        Navigator.of(context).pop(drugsName);
      } else {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            backgroundColor: Color(0xff5C376D),
            content: Text(
